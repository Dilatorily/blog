...
const App = ({ posts }) => (
  <div style={styles.container}>
      ...
      <div style={styles.avatarContainer}>
        ...
        <div style={styles.headerTextContainer}>
          ...
          <div>
            ...
            <a key="twitter" title="Twitter" href="https://twitter.com/Dagneau" className="link" style={[styles.link, styles.icon]}><SVGIcon path={twitter} /></a>
          </div>
        </div>
      </div>
    </header>
    ...
    <div style={styles.contentContainer}>
      <Switch>
        <Route exact path="/" render={() => <Home {...{ posts }} />} />
        <Route exact path="/posts/:date" render={({ match }) => <Post {...{ match, posts }} />} />
        <Redirect push to="/" />
      </Switch>
    </div>
  </div>
